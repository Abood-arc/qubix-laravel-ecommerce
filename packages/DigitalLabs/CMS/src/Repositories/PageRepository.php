...
namespace DigitalLabs\CMS\Repositories;

use Illuminate\Database\Eloquent\ModelNotFoundException;
use DigitalLabs\CMS\Models\PageTranslationProxy;
...
class PageRepository extends Repository
{
    ...
    {
        return 'DigitalLabs\CMS\Contracts\Page';
    }
     ...
     *
     * @param  string  $urlKey
     * @return \DigitalLabs\CMS\Contracts\Page|\Exception
     */

...
class CustomerRepository extends Repository
{
    ...
    {
        return 'DigitalLabs\Customer\Contracts\Customer';
    }

    /**
     * Check if customer has order pending or processing.
     *
     * @param  \DigitalLabs\Customer\Models\Customer
     * @return bool
     */
     ...
     *
     * @return \DigitalLabs\Customer\Models\CustomerGroup
     */
     ...
     *
     * @param  array  $data
     * @param  \DigitalLabs\Customer\Models\Customer  $customer
     * @param  string  $type
     * @return void
     */
     ...
     *
     * @param  \DigitalLabs\Customer\Contracts\Customer  $customer
     * @return mixed
     */
    public function syncNewRegisteredCustomerInformation($customer)
    {
        ...
        Order::where('customer_email', $customer->email)->update([
            ...
            'customer_type' => \DigitalLabs\Customer\Models\Customer::class,
        ]);

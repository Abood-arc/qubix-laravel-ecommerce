...
use DigitalLabs\BookingProduct\Contracts\BookingProduct;
use DigitalLabs\BookingProduct\Repositories\BookingProductAppointmentSlotRepository;
use DigitalLabs\BookingProduct\Repositories\BookingProductDefaultSlotRepository;
use DigitalLabs\BookingProduct\Repositories\BookingProductEventTicketRepository;
use DigitalLabs\BookingProduct\Repositories\BookingProductRentalSlotRepository;
use DigitalLabs\BookingProduct\Repositories\BookingProductRepository;
use DigitalLabs\BookingProduct\Repositories\BookingProductTableSlotRepository;
...
class Booking
{
     ...
     *
     * @param  \DigitalLabs\Checkout\Contracts\CartItem|array  $cartItem
     */

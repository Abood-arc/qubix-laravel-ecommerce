...
namespace DigitalLabs\Category\Models;
...
use DigitalLabs\Category\Contracts\Category as CategoryContract;
use DigitalLabs\Category\Database\Factories\CategoryFactory;

...
namespace DigitalLabs\Category\Repositories;

use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Str;
use Intervention\Image\ImageManager;
use DigitalLabs\Category\Contracts\Category;
use DigitalLabs\Category\Models\CategoryTranslationProxy;
...
class CategoryRepository extends Repository
{
     ...
     * Create category.
     *
     * @return \DigitalLabs\Category\Contracts\Category
     */

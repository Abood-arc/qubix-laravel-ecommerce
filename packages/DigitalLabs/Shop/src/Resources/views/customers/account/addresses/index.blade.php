<x-shop::layouts.account>
    ...
    <div class="flex-auto mx-4">
        ...
        @if (! $addresses->isEmpty())
            ...
            {!! view_render_event('qubix.shop.customers.account.addresses.list.before', ['addresses' => $addresses]) !!}
            ...
            {!! view_render_event('qubix.shop.customers.account.addresses.list.after', ['addresses' => $addresses]) !!}
        ...
        @else
            ...
            <div class="grid items-center w-full py-32 m-auto text-center place-content-center justify-items-center">
                <img 
                    ...
                    src="{{ qubix_asset('images/no-address.png') }}" 
                    alt="Empty Address" 
                    title=""
                >

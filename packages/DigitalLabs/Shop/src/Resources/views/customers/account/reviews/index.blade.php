    ...
    @pushOnce('scripts')
        ...
        >
            <div>
                ...
                {!! view_render_event('qubix.shop.customers.account.reviews.list.before', ['reviews' => $reviews]) !!}
                            ...
                            @foreach($reviews as $review)
                                ...
                                >
                                    ...
                                    <div class="flex gap-5 rounded-xl border border-zinc-200 p-6 max-md:hidden max-md:gap-1.5">
                                        {!! view_render_event('qubix.shop.customers.account.reviews.image.before', ['reviews' => $reviews]) !!}

                                        <x-shop::media.images.lazy
                                            class="h-[146px] max-h-[146px] w-32 min-w-32 max-w-32 rounded-xl"
                                            src="{{ $review->product->base_image_url ?? qubix_asset('images/small-product-placeholder.webp') }}"
                                            alt="Review Image"                   
                                        />

                                        {!! view_render_event('qubix.shop.customers.account.reviews.image.after', ['reviews' => $reviews]) !!}

                                        <div class="w-full">
                                            <div class="flex justify-between">
                                                {!! view_render_event('qubix.shop.customers.account.reviews.title.before', ['reviews' => $reviews]) !!}
                                                ...
                                                {!! view_render_event('qubix.shop.customers.account.reviews.title.after', ['reviews' => $reviews]) !!}
        
                                                {!! view_render_event('qubix.shop.customers.account.reviews.rating.before', ['reviews' => $reviews]) !!}
                                                ...
                                                {!! view_render_event('qubix.shop.customers.account.reviews.rating.after', ['reviews' => $reviews]) !!}
                                            </div>
        
                                            {!! view_render_event('qubix.shop.customers.account.reviews.created_at.before', ['reviews' => $reviews]) !!}
                                            ...
                                            {!! view_render_event('qubix.shop.customers.account.reviews.created_at.after', ['reviews' => $reviews]) !!}

                                            {!! view_render_event('qubix.shop.customers.account.reviews.comment.before', ['reviews' => $reviews]) !!}
                                            ...
                                            {!! view_render_event('qubix.shop.customers.account.reviews.comment.after', ['reviews' => $reviews]) !!}
                                        </div>
                    ...
                    @else
                        ...
                        <div class="m-auto grid w-full place-content-center items-center justify-items-center py-32 text-center">
                            <img
                                ...
                                src="{{ qubix_asset('images/review.png') }}"
                                alt="Empty Review"
                                title=""
                            >
                ...
                {!! view_render_event('qubix.shop.customers.account.reviews.list.after', ['reviews' => $reviews]) !!}

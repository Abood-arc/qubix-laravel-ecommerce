...
>
    ...
    <div class="container mt-20 max-1180:px-5 max-md:mt-12">
        {!! view_render_event('qubix.shop.customers.login.logo.before') !!}
        ...
        <div class="flex items-center gap-x-14 max-[1180px]:gap-x-9">
            <a
                ...
                aria-label="@lang('shop::app.customers.login-form.qubix')"
            >
                <img
        ...
        {!! view_render_event('qubix.shop.customers.login.logo.after') !!}
        ...
        <div class="m-auto w-full max-w-[870px] rounded-xl border border-zinc-200 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
            ...
            {!! view_render_event('qubix.shop.customers.login.before') !!}

            <div class="mt-14 rounded max-sm:mt-8">
                <x-shop::form :action="route('shop.customer.session.create')">

                    {!! view_render_event('qubix.shop.customers.login_form_controls.before') !!}
            ...
            {!! view_render_event('qubix.shop.customers.login.after') !!}
        ...
        <p class="mb-4 mt-8 text-center text-xs text-zinc-500">
            @lang('shop::app.customers.login-form.footer', ['current_year'=> date('Y'), 'app_name' => config('app.name') ])
        </p>
    </div>

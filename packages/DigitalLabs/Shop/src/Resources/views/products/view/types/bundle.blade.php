@if ($product->type == 'bundle')
    {!! view_render_event('qubix.shop.products.view.bundle-options.before', ['product' => $product]) !!}

    <v-product-bundle-options :errors="errors"></v-product-bundle-options>

    {!! view_render_event('qubix.shop.products.view.bundle-options.after', ['product' => $product]) !!}
    ...
    @pushOnce('scripts')
        ...
        <script type="module">
            app.component('v-product-bundle-options', {
                ...
                data: function() {
                    return {
                        config: @json(app('DigitalLabs\Product\Helpers\BundleOption')->getBundleConfig($product)),

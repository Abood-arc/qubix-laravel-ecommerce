...
>
    ...
    {!! view_render_event('qubix.shop.checkout.cart.header.before') !!}
    {{-- Primary nav is rendered via x-shop::layouts (:has-header="true"); keep hooks for integrations. --}}
    {!! view_render_event('qubix.shop.checkout.cart.logo.before') !!}
    {!! view_render_event('qubix.shop.checkout.cart.logo.after') !!}
    {!! view_render_event('qubix.shop.checkout.cart.header.after') !!}

    <div class="flex-auto">
        <div class="container px-[60px] max-lg:px-8 max-md:px-4">

            {!! view_render_event('qubix.shop.checkout.cart.breadcrumbs.before') !!}
            ...
            {!! view_render_event('qubix.shop.checkout.cart.breadcrumbs.after') !!}

            @php
                $errors = \DigitalLabs\Checkout\Facades\Cart::getErrors();
            @endphp
    ...
    @if (core()->getConfigData('sales.checkout.shopping_cart.cross_sell'))
        {!! view_render_event('qubix.shop.checkout.cart.cross_sell_carousel.before') !!}
        ...
        {!! view_render_event('qubix.shop.checkout.cart.cross_sell_carousel.after') !!}
    @endif
                ...
                <template v-else>
                    ...
                    >
                        <div class="flex flex-1 flex-col gap-6 max-md:gap-5">
                            ...
                            {!! view_render_event('qubix.shop.checkout.cart.cart_mass_actions.before') !!}
                            ...
                            {!! view_render_event('qubix.shop.checkout.cart.cart_mass_actions.after') !!}

                            {!! view_render_event('qubix.shop.checkout.cart.item.listing.before') !!}
                            ...
                            >
                                <div class="flex justify-between gap-x-2.5 border-b border-zinc-200 pb-5">
                                    <div class="flex gap-x-5">
                                        ...
                                        {!! view_render_event('qubix.shop.checkout.cart.item_image.before') !!}
                                        ...
                                        {!! view_render_event('qubix.shop.checkout.cart.item_image.after') !!}

                                        <!-- Cart Item Options Container -->
                                        <div class="grid place-content-start gap-y-2.5 max-md:gap-y-0">
                                            {!! view_render_event('qubix.shop.checkout.cart.item_name.before') !!}
                                            ...
                                            {!! view_render_event('qubix.shop.checkout.cart.item_name.after') !!}

                                            {!! view_render_event('qubix.shop.checkout.cart.item_details.before') !!}
                                            ...
                                            {!! view_render_event('qubix.shop.checkout.cart.item_details.after') !!}

                                            {!! view_render_event('qubix.shop.checkout.cart.formatted_total.before') !!}
                                            ...
                                            {!! view_render_event('qubix.shop.checkout.cart.formatted_total.after') !!}

                                            {!! view_render_event('qubix.shop.checkout.cart.quantity_changer.before') !!}
                                            ...
                                            {!! view_render_event('qubix.shop.checkout.cart.quantity_changer.after') !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="max-md:hidden ltr:text-right rtl:text-left">
                                        ...
                                        {!! view_render_event('qubix.shop.checkout.cart.total.after') !!}

                                        {!! view_render_event('qubix.shop.checkout.cart.remove_button.before') !!}
                                        ...
                                        {!! view_render_event('qubix.shop.checkout.cart.remove_button.after') !!}
                                    </div>
                                </div>
                            </div>

                            {!! view_render_event('qubix.shop.checkout.cart.item.listing.after') !!}

                            {!! view_render_event('qubix.shop.checkout.cart.controls.before') !!}

                            <!-- Cart Item Actions -->
                            <div class="flex flex-wrap justify-end gap-8 max-md:justify-between max-md:gap-5">
                                {!! view_render_event('qubix.shop.checkout.cart.continue_shopping.before') !!}
                                ...
                                {!! view_render_event('qubix.shop.checkout.cart.continue_shopping.after') !!}

                                {!! view_render_event('qubix.shop.checkout.cart.update_cart.before') !!}
                                ...
                                {!! view_render_event('qubix.shop.checkout.cart.update_cart.after') !!}
                            </div>

                            {!! view_render_event('qubix.shop.checkout.cart.controls.after') !!}
                        </div>

                        {!! view_render_event('qubix.shop.checkout.cart.summary.before') !!}

                        <!-- Cart Summary Blade File -->
                        @include('shop::checkout.cart.summary')

                        {!! view_render_event('qubix.shop.checkout.cart.summary.after') !!}
                    </div>
                    ...
                    >
                        <img
                            ...
                            src="{{ qubix_asset('images/thank-you.png') }}"

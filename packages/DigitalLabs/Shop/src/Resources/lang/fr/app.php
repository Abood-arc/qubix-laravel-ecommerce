...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Droits d’auteur 2010 - :current_year, DigitalLabs Software (enregistré en Inde). Tous droits réservés.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text' => '© Copyright 2010 - :current_year, DigitalLabs Software (enregistré en Inde). Tous droits réservés.',
                'locale' => 'Langue',

...
use DigitalLabs\Core\Http\Middleware\NoCacheMiddleware;
use DigitalLabs\Shop\Http\Controllers\Customer\Account\AddressController;
use DigitalLabs\Shop\Http\Controllers\Customer\Account\DownloadableProductController;
use DigitalLabs\Shop\Http\Controllers\Customer\Account\OrderController;
use DigitalLabs\Shop\Http\Controllers\Customer\Account\WishlistController;
use DigitalLabs\Shop\Http\Controllers\Customer\CustomerController;
use DigitalLabs\Shop\Http\Controllers\Customer\ForgotPasswordController;
use DigitalLabs\Shop\Http\Controllers\Customer\GDPRController;
use DigitalLabs\Shop\Http\Controllers\Customer\RegistrationController;
use DigitalLabs\Shop\Http\Controllers\Customer\ResetPasswordController;
use DigitalLabs\Shop\Http\Controllers\Customer\SessionController;
use DigitalLabs\Shop\Http\Controllers\DataGridController;

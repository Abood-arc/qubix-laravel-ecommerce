...
use DigitalLabs\CartRule\Models\CartRule;
use DigitalLabs\CartRule\Models\CartRuleCoupon;
use DigitalLabs\CatalogRule\Models\CatalogRule;
use DigitalLabs\CatalogRule\Models\CatalogRuleProductPrice;
...
it('should add a virtual product to the cart with a cart rule of the specific coupon type for all customer grouped types', function () {
    ...
    $cartRuleCoupon = CartRuleCoupon::factory()->create([
        'cart_rule_id' => $cartRule->id,
        'code' => $couponCode = fake()->numerify('qubix-########'),
        'type' => 0,
        'is_primary' => 1,
    ]);

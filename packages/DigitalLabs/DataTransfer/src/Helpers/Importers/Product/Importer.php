...
namespace DigitalLabs\DataTransfer\Helpers\Importers\Product;
...
use DigitalLabs\Attribute\Repositories\AttributeFamilyRepository;
use DigitalLabs\Attribute\Repositories\AttributeOptionRepository;
use DigitalLabs\Attribute\Repositories\AttributeRepository;
use DigitalLabs\Category\Repositories\CategoryRepository;
use DigitalLabs\Core\Repositories\ChannelRepository;
use DigitalLabs\Core\Rules\Decimal;
use DigitalLabs\Core\Rules\Slug;
use DigitalLabs\Customer\Repositories\CustomerGroupRepository;
use DigitalLabs\DataTransfer\Contracts\ImportBatch as ImportBatchContract;
use DigitalLabs\DataTransfer\Helpers\Import;
use DigitalLabs\DataTransfer\Helpers\Importers\AbstractImporter;
use DigitalLabs\DataTransfer\Repositories\ImportBatchRepository;
use DigitalLabs\Inventory\Repositories\InventorySourceRepository;
use DigitalLabs\Product\Jobs\ElasticSearch\DeleteIndex as DeleteIndexJob;
use DigitalLabs\Product\Jobs\ElasticSearch\UpdateCreateIndex as UpdateCreateElasticSearchIndexJob;
use DigitalLabs\Product\Jobs\UpdateCreateInventoryIndex as UpdateCreateInventoryIndexJob;
use DigitalLabs\Product\Jobs\UpdateCreatePriceIndex as UpdateCreatePriceIndexJob;
use DigitalLabs\Product\Models\Product as ProductModel;
use DigitalLabs\Product\Repositories\ProductAttributeValueRepository;
use DigitalLabs\Product\Repositories\ProductBundleOptionProductRepository;
use DigitalLabs\Product\Repositories\ProductBundleOptionRepository;
use DigitalLabs\Product\Repositories\ProductCustomerGroupPriceRepository;
use DigitalLabs\Product\Repositories\ProductFlatRepository;
use DigitalLabs\Product\Repositories\ProductGroupedProductRepository;
use DigitalLabs\Product\Repositories\ProductImageRepository;
use DigitalLabs\Product\Repositories\ProductInventoryRepository;

...
namespace DigitalLabs\Checkout;

use Illuminate\Support\Facades\Event;
use DigitalLabs\Checkout\Contracts\CartAddress as CartAddressContract;
use DigitalLabs\Checkout\Exceptions\BillingAddressNotFoundException;
use DigitalLabs\Checkout\Models\CartAddress;
use DigitalLabs\Checkout\Models\CartPayment;
use DigitalLabs\Checkout\Repositories\CartAddressRepository;
use DigitalLabs\Checkout\Repositories\CartItemRepository;
use DigitalLabs\Checkout\Repositories\CartRepository;
use DigitalLabs\Customer\Contracts\Customer as CustomerContract;
use DigitalLabs\Customer\Contracts\Wishlist as WishlistContract;
use DigitalLabs\Customer\Repositories\CustomerAddressRepository;
use DigitalLabs\Customer\Repositories\WishlistRepository;
use DigitalLabs\Product\Contracts\Product as ProductContract;
...
class Cart
{
     ...
     * The cart instance.
     *
     * @var \DigitalLabs\Checkout\Contracts\Cart
     */
    private $cart;

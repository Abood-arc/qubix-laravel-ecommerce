...
namespace DigitalLabs\Admin\Http\Controllers\Settings\Tax;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use DigitalLabs\Admin\DataGrids\Settings\TaxCategoryDataGrid;
use DigitalLabs\Admin\Http\Controllers\Controller;
use DigitalLabs\Admin\Http\Resources\TaxCategoryResource;

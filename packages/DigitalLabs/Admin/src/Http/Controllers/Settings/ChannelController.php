...
namespace DigitalLabs\Admin\Http\Controllers\Settings;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use DigitalLabs\Admin\DataGrids\Settings\ChannelDataGrid;
...
class ChannelController extends Controller
{
    ...
    public function store()
    {
        $data = $this->validate(request(), [
            /* general */
            'code' => ['required', 'unique:channels,code', new \DigitalLabs\Core\Rules\Code],
            'name' => 'required',
    ...
    public function update(int $id)
    {
        ...
        $data = $this->validate(request(), [
            /* general */
            'code' => ['required', 'unique:channels,code,'.$id, new \DigitalLabs\Core\Rules\Code],

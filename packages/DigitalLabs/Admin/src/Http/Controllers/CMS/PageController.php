...
namespace DigitalLabs\Admin\Http\Controllers\CMS;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use DigitalLabs\Admin\DataGrids\CMS\CMSPageDataGrid;
...
class PageController extends Controller
{
    ...
    public function store()
    {
        $this->validate(request(), [
            'url_key' => ['required', 'unique:cms_page_translations,url_key', new \DigitalLabs\Core\Rules\Slug],
            'page_title' => 'required',

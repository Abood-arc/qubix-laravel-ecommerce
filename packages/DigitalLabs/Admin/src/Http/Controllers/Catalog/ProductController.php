...
namespace DigitalLabs\Admin\Http\Controllers\Catalog;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Storage;
use DigitalLabs\Admin\DataGrids\Catalog\ProductDataGrid;
use DigitalLabs\Admin\Http\Controllers\Controller;
use DigitalLabs\Admin\Http\Requests\InventoryRequest;
use DigitalLabs\Admin\Http\Requests\MassDestroyRequest;
use DigitalLabs\Admin\Http\Requests\MassUpdateRequest;
use DigitalLabs\Admin\Http\Requests\ProductForm;
use DigitalLabs\Admin\Http\Resources\AttributeResource;
use DigitalLabs\Admin\Http\Resources\ProductResource;
...
use DigitalLabs\Product\Helpers\Product;
use DigitalLabs\Product\Helpers\ProductType;
use DigitalLabs\Product\Repositories\ProductAttributeValueRepository;
use DigitalLabs\Product\Repositories\ProductDownloadableLinkRepository;
use DigitalLabs\Product\Repositories\ProductDownloadableSampleRepository;

...
namespace DigitalLabs\Admin\Http\Controllers\Marketing\Communications;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use DigitalLabs\Admin\DataGrids\Marketing\Communications\CampaignDataGrid;
use DigitalLabs\Admin\Http\Controllers\Controller;
use DigitalLabs\Marketing\Repositories\CampaignRepository;
use DigitalLabs\Marketing\Repositories\TemplateRepository;

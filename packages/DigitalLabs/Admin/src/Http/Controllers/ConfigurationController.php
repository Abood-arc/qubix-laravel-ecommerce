...
namespace DigitalLabs\Admin\Http\Controllers;
...
use DigitalLabs\Admin\Http\Requests\ConfigurationForm;
use DigitalLabs\Core\Repositories\CoreConfigRepository;

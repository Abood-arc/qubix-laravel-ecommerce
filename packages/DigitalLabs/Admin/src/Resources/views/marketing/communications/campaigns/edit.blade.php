<x-admin::layouts>
    ...
    {!! view_render_event('qubix.admin.marketing.communications.campaigns.edit.before', ['campaign' => $campaign]) !!}
    ...
    >
        ...
        {!! view_render_event('qubix.admin.marketing.communications.campaigns.create.create_form_controls.before', ['campaign' => $campaign]) !!}
        ...
        <div class="mb-2 mt-7 flex gap-2.5">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('qubix.admin.marketing.communications.campaigns.edit.card.general.before', ['campaign' => $campaign]) !!}
                    ...
                    <div class="mb-2.5">
                        ...
                        <x-admin::form.control-group>
                         ...
                         <x-admin::form.control-group>
                            ...
                            >
                                @foreach (app('DigitalLabs\Marketing\Repositories\EventRepository')->all() as $event)
                                    <option
                                        value="{{ $event->id }}"
                ...
                {!! view_render_event('qubix.admin.marketing.communications.campaigns.edit.card.general.after', ['campaign' => $campaign]) !!}
            </div>

             <!-- Right Section -->
             <div class="flex w-[360px] max-w-full flex-col gap-2 max-md:w-full">

                {!! view_render_event('qubix.admin.marketing.communications.campaigns.edit.card.accordion.setting.before', ['campaign' => $campaign]) !!}
                ...
                <x-admin::accordion>
                    ...
                    <x-slot:content>
                         ...
                         <x-admin::form.control-group>
                            ...
                            >
                                @foreach (app('DigitalLabs\Core\Repositories\ChannelRepository')->all() as $channel)
                                    <option
                                        value="{{ $channel->id }}"
                ...
                {!! view_render_event('qubix.admin.marketing.communications.campaigns.edit.card.accordion.setting.after', ['campaign' => $campaign]) !!}

            </div>
        </div>

        {!! view_render_event('qubix.admin.marketing.communications.campaigns.create.create_form_controls.after', ['campaign' => $campaign]) !!}

    </x-admin::form>

    {!! view_render_event('qubix.admin.marketing.communications.campaigns.edit.after', ['campaign' => $campaign]) !!}

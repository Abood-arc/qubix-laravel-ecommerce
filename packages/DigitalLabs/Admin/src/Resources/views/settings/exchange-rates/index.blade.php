<x-admin::layouts>
    ...
    {!! view_render_event('qubix.admin.settings.exchange_rates.create.before') !!}
    ...
    {!! view_render_event('qubix.admin.settings.exchange_rates.create.after') !!}
            ...
            >
                ...
                >
                    ...
                    <x-admin::modal ref="exchangeRateUpdateOrCreateModal">
                        ...
                        <!-- Modal Content -->
                        <x-slot:content>
                            {!! view_render_event('qubix.admin.settings.exchangerate.create.before') !!}

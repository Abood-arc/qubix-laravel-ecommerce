...
<head>
    ...
    @else
        <link
            type="image/x-icon"
            href="{{ qubix_asset('images/favicon.ico') }}"
            rel="shortcut icon"
            sizes="16x16"
        />
    @endif
    ...
    {!! view_render_event('qubix.admin.layout.head.after') !!}
</head>
...
<body class="h-full dark:bg-gray-950">
    ...
    >
        ...
        {!! view_render_event('qubix.admin.layout.content.before') !!}
        ...
        >
            ...
            <div class="flex min-h-[calc(100vh-62px)] max-w-full flex-1 flex-col bg-white transition-all duration-300 dark:bg-gray-950 pt-3 px-2 sm:px-4 lg:pt-3 lg:px-4 lg:ltr:pl-[286px] lg:group-[.sidebar-collapsed]/container:ltr:pl-[85px] lg:rtl:pr-[286px] lg:group-[.sidebar-collapsed]/container:rtl:pr-[85px]">
                ...
                <div class="pb-4 lg:pb-6">
                    <!-- Todo @suraj-digitalLabs need to optimize below statement. -->
        ...
        {!! view_render_event('qubix.admin.layout.content.after') !!}
    </div>

    {!! view_render_event('qubix.admin.layout.body.after') !!}

    @stack('scripts')

    {!! view_render_event('qubix.admin.layout.vue-app-mount.before') !!}
    ...
    {!! view_render_event('qubix.admin.layout.vue-app-mount.after') !!}
</body>

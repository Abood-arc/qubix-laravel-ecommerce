{!! view_render_event('qubix.admin.catalog.product.edit.form.images.before', ['product' => $product]) !!}
...
{!! view_render_event('qubix.admin.catalog.product.edit.form.images.after', ['product' => $product]) !!}
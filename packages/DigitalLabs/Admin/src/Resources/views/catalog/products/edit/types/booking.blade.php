@php
    $bookingProduct = app('\DigitalLabs\BookingProduct\Repositories\BookingProductRepository')->findOneByField('product_id', $product->id)
@endphp

{!! view_render_event('qubix.admin.catalog.product.edit.form.types.booking.before', ['product' => $product]) !!}

<!-- Vue Component -->
<v-booking-information></v-booking-information>

{!! view_render_event('qubix.admin.catalog.product.edit.form.types.booking.after', ['product' => $product]) !!}

{!! view_render_event('qubix.admin.catalog.product.edit.form.inventories.controls.before', ['product' => $product]) !!}
...
<v-inventories>
    ...
    @foreach (app(\DigitalLabs\Inventory\Repositories\InventorySourceRepository::class)->findWhere(['status' => 1]) as $inventorySource)
        @php
...
{!! view_render_event('qubix.admin.catalog.product.edit.form.inventories.controls.after', ['product' => $product]) !!}

...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'パスワード',
            'powered-by-description' => ':digitalLabs によるオープンソースプロジェクト :qubix によって提供されています。',
            'submit-btn' => 'サインイン',
            'title' => 'サインイン',
        ],
        ...
        'index' => [
            ...
            'general' => [
                ...
                'design' => [
                    ...
                    'storefront-branding' => [
                        'info' => 'プライマリブランドカラーを1つ選択してください。ストアのヘッダー、フッター、ボタンはこの色から自動的に色合いを生成します。',
                        'title' => 'ストアのブランディング',
                    ],
                ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => ':digitalLabs によるオープンソースプロジェクト :qubix によって提供されています。',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '搭載 <a href="https://qubix.com/" target="_blank">Qubix</a>, DigitalLabsによるコミュニティプロジェクト<a href="https://digitalLabs.com/" target="_blank">DigitalLabs</a>',
    ],

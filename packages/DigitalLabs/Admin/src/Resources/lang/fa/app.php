...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'رمز عبور',
            'powered-by-description' => 'قدرت گرفته از :qubix، یک پروژه متن‌باز توسط :digitalLabs.',
            'submit-btn' => 'ورود',
            'title' => 'ورود',
        ],
        ...
        'index' => [
            ...
            'general' => [
                ...
                'design' => [
                    ...
                    'storefront-branding' => [
                        'info' => 'یک رنگ اصلی برند انتخاب کنید. هدر، فوتر و دکمه‌های فروشگاه به‌طور خودکار سایه‌های خود را از این رنگ می‌گیرند.',
                        'title' => 'برندسازی فروشگاه',
                    ],
                ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'قدرت گرفته از :qubix، یک پروژه متن‌باز توسط :digitalLabs.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'قدرت گرفته از <a href="https://qubix.com/" target="_blank">Qubix</a>، یک پروژه اجتماعی توسط <a href="https://digitalLabs.com/" target="_blank">DigitalLabs</a>',
    ],

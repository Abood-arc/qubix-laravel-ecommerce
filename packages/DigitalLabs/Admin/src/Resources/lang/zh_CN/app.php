...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => '密码',
            'powered-by-description' => '由 :qubix 提供支持，一个由 :digitalLabs 社区支持的项目。',
            'submit-btn' => '登录',
            'title' => '登录',
        ],
        ...
        'index' => [
            ...
            'general' => [
                ...
                'design' => [
                    ...
                    'storefront-branding' => [
                        'info' => '选择一个主要品牌颜色。商店的页眉、页脚和按钮将自动从该颜色派生出各自的色调。',
                        'title' => '店面品牌设置',
                    ],
                ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '由 :qubix 提供支持，一个由 :digitalLabs 社区支持的项目。',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '由 <a href="https://qubix.com/" target="_blank">Qubix</a> 提供支持，一个由 <a href="https://digitalLabs.com/" target="_blank">DigitalLabs</a> 社区支持的项目',
    ],

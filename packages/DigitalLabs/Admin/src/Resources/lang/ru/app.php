...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Пароль',
            'powered-by-description' => 'Работает на :qubix, проект с открытым исходным кодом от :digitalLabs.',
            'submit-btn' => 'Войти',
            'title' => 'Войти',
        ],
        ...
        'index' => [
            ...
            'general' => [
                ...
                'design' => [
                    ...
                    'storefront-branding' => [
                        'info' => 'Выберите один основной цвет бренда. Шапка, подвал и кнопки магазина автоматически получат свои оттенки на основе этого цвета.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Работает на :qubix, проект с открытым исходным кодом от :digitalLabs.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'Разработано на платформе <a href="https://qubix.com/" target="_blank">Qubix</a>, Проект сообщества <a href="https://digitalLabs.com/" target="_blank">DigitalLabs</a>',
    ],

...
namespace DigitalLabs\CartRule\Helpers;

use Carbon\Carbon;
use Illuminate\Database\Eloquent\Builder;
use DigitalLabs\CartRule\Repositories\CartRuleCouponRepository;
use DigitalLabs\CartRule\Repositories\CartRuleCouponUsageRepository;
use DigitalLabs\CartRule\Repositories\CartRuleCustomerRepository;
use DigitalLabs\CartRule\Repositories\CartRuleRepository;
...
use DigitalLabs\Rule\Helpers\Validator;
...
class CartRule
{
     ...
     *
     * @param  \DigitalLabs\CartRule\Contracts\CartRule  $rule
     */
    public function canProcessRule($rule): bool
    {
        if ($rule->coupon_type) {
            ...
            /** @var \DigitalLabs\CartRule\Models\CartRule $rule */

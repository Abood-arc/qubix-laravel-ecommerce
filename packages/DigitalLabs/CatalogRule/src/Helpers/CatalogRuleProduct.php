...
namespace DigitalLabs\CatalogRule\Helpers;

use Carbon\Carbon;
use DigitalLabs\Attribute\Repositories\AttributeRepository;
use DigitalLabs\CatalogRule\Repositories\CatalogRuleProductRepository;
...
class CatalogRuleProduct
{
     ...
     *
     * @param  \DigitalLabs\CatalogRule\Contracts\CatalogRule  $rule

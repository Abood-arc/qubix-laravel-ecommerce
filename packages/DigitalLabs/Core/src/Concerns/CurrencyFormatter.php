...
namespace DigitalLabs\Core\Concerns;

use DigitalLabs\Core\Contracts\Currency;
...
trait CurrencyFormatter
{
     ...
     *
     * @param  string|\DigitalLabs\Core\Contracts\Currency  $currency
     */
    public function currencySymbol($currency): string
    {
        $code = $currency instanceof \DigitalLabs\Core\Contracts\Currency ? $currency->code : $currency;

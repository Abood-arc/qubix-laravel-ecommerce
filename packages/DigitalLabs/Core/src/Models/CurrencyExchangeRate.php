...
use DigitalLabs\Admin\Database\Factories\CurrencyExchangeRateFactory;
use DigitalLabs\Core\Contracts\CurrencyExchangeRate as CurrencyExchangeRateContract;

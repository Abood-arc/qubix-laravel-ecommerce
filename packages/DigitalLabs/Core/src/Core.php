...
use DigitalLabs\Core\Concerns\CurrencyFormatter;
use DigitalLabs\Core\Models\Channel;
use DigitalLabs\Core\Repositories\ChannelRepository;
use DigitalLabs\Core\Repositories\CountryRepository;
use DigitalLabs\Core\Repositories\CountryStateRepository;
use DigitalLabs\Core\Repositories\CurrencyRepository;
use DigitalLabs\Core\Repositories\ExchangeRateRepository;
use DigitalLabs\Core\Repositories\LocaleRepository;
use DigitalLabs\Customer\Repositories\CustomerGroupRepository;
use DigitalLabs\Tax\Repositories\TaxCategoryRepository;
...
class Core
{
     ...
     * @var string
     */
    const QUBIX_VERSION = '2.3.14';

    /**
     * Current Channel.
     *
     * @var \DigitalLabs\Core\Models\Channel
     */
     ...
     * Currency.
     *
     * @var \DigitalLabs\Core\Models\Currency
     */
     ...
     * Current Locale.
     *
     * @var \DigitalLabs\Core\Models\Locale
     */
     ...
     *
     * @var \DigitalLabs\Customer\Models\CustomerGroup
     */
    ...
    /**
     * Get the version number of the Qubix.
     *
     * @return string
     */
    public function version()
    {
        return static::QUBIX_VERSION;
    }
     ...
     *
     * @return \DigitalLabs\Core\Contracts\Locale
     */
     ...
     *
     * @return \DigitalLabs\Core\Contracts\Currency
     */
     ...
     *
     * @param  int|string|\DigitalLabs\Core\Contracts\Channel  $channel
     ...
     *
     * @return \DigitalLabs\Customer\Contract\CustomerGroup
     */

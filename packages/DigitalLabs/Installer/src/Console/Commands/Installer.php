...
use DigitalLabs\Installer\Events\ComposerEvents;
use DigitalLabs\Installer\Helpers\DatabaseManager;
...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'qubix:install
     ...
     * @var string
     */
    protected $description = 'Qubix installer.';
    ...
    public function handle(): void
    {
        ...
        $this->warn('Step: Seeding basic data for Qubix kickstart...');
        app(QubixDatabaseSeeder::class)->run($this->getSeederConfiguration());
    ...
    protected function askForApplicationDetails(): void
    {
        $this->updateTextTypeEnv(
            ...
            $this->getEnvVariable('APP_NAME', 'Qubix')
        );
    ...
    protected function askForAdminDetails()
    {
        ...
        try {
            ...
            File::put($filePath, 'Qubix is successfully installed.');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use Qubix.');
            ...
            Event::dispatch('qubix.installed');
        } catch (\Exception $e) {
    ...
    protected function askForGithubStar(): void
    {
        ...
        $repoUrl = 'https://github.com/qubix/qubix';

...
use DigitalLabs\Installer\Database\Seeders\Category\CategoryTableSeeder;
...
class ProductTableSeeder extends Seeder
{
     ...
     */
    const BASE_PATH = 'packages/DigitalLabs/Installer/src/Resources/assets/images/seeders/products/';

...
namespace DigitalLabs\Installer\Http\Controllers;
...
use DigitalLabs\Installer\Helpers\EnvironmentManager;
use DigitalLabs\Installer\Helpers\ServerRequirements;
use DigitalLabs\Product\Console\Commands\Indexer;
...
class InstallerController extends Controller
{
    ...
    public function smtpConfigSetup()
    {
        ...
        File::put($filePath, 'Your Qubix App is Successfully Installed');

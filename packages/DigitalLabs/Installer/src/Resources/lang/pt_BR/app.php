    ...
    'installer' => [
        ...
        'index' => [
            ...
            'installation-processing' => [
                'qubix' => 'Instalação do Qubix',
                'qubix-info' => 'A criação de tabelas no banco de dados pode levar alguns momentos',
                'title' => 'Instalação',
            ],

            'installation-completed' => [
                'admin-panel' => 'Painel de Administração',
                'qubix-forums' => 'Fórum Qubix',
                'customer-panel' => 'Painel do Cliente',
                'explore-qubix-extensions' => 'Explorar Extensões Qubix',
                'title' => 'Instalação Concluída',
                'title-info' => 'O Qubix foi instalado com sucesso no seu sistema.',
            ],
            ...
            'back' => 'Wstecz',
            'qubix' => 'Qubix',
            'qubix-info' => 'Projekt społecznościowy',
            ...
            'installation-description' => 'A instalação do Qubix geralmente envolve várias etapas. Aqui está uma visão geral do processo de instalação do Qubix',

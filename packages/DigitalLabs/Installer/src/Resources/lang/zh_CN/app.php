    ...
    'seeders' => [
        ...
        'cms' => [
            'pages' => [
                ...
                'customer-service' => [
                    'content' => '我們的客戶服務資訊正在完善中。如需協助，請立即聯繫我們。',
                    'title' => '客戶服務',
                ],

                'payment-policy' => [
                    'content' => '我們的付款政策目前正在完善中。如需了解詳情，請聯繫我們。',
                    'title' => '付款政策',
                ],

                'privacy-policy' => [
                    'content' => '我們的隱私政策目前正在完善中。如需了解詳情，請聯繫我們。',
                    'title' => '隱私政策',
                ],

                'refund-policy' => [
                    'content' => '我們的退款政策目前正在完善中。如需了解詳情，請聯繫我們。',
                    'title' => '退款政策',
                ],

                'return-policy' => [
                    'content' => '我們的退貨政策目前正在完善中。如需了解詳情，請聯繫我們。',
                    'title' => '退貨政策',
                ],

                'shipping-policy' => [
                    'content' => '我們的運送政策目前正在完善中。如需了解詳情，請聯繫我們。',
                    'title' => '運送政策',
                ],

                'terms-conditions' => [
                    'content' => '我們的條款和條件目前正在完善中。如需了解詳情，請聯繫我們。',
                    'title' => '條款和條件',
                ],

                'terms-of-use' => [
                    'content' => '我們的使用條款目前正在完善中。如需了解詳情，請聯繫我們。',
                    'title' => '使用條款',
                ],

                'whats-new' => [
                    'content' => '此版塊正在更新最新消息。請稍後再來查看。',
                    'title' => '最新消息',
                ],
            ],
        ],
    ...
    'installer' => [
        ...
        'index' => [
            ...
            'installation-processing' => [
                'qubix' => 'Qubix 安装',
                'qubix-info' => '正在创建数据库表，这可能需要一些时间',
                'title' => '安装',
            ],

            'installation-completed' => [
                'admin-panel' => '管理员面板',
                'qubix-forums' => 'Qubix 论坛',
                'customer-panel' => '客户面板',
                'explore-qubix-extensions' => '探索 Qubix 扩展',
                'title' => '安装已完成',
                'title-info' => 'Qubix 已成功安装在您的系统上。',
            ],

            'ready-for-installation' => [
                'create-database-table' => '创建数据库表',
                'install' => '安装',
                'install-info' => 'Qubix 安装信息',
            ...
            'back' => '返回',
            'qubix' => 'Qubix',
            'qubix-info' => '由 DigitalLabs 社区共同开发的项目',
            ...
            'hindi' => '印地语',
            'indonesian' => '印尼语',
            'installation-description' => 'Qubix 的安装通常涉及几个步骤。以下是 Qubix 安装过程的一般概述',
            'installation-info' => '我们很高兴在这里见到你！',
            'installation-title' => '欢迎安装 Qubix',
            'italian' => '意大利语',
            'japanese' => '日语',
            'persian' => '波斯语',
            'polish' => '波兰语',

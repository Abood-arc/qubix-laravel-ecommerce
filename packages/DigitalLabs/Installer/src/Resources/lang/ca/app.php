    ...
    'installer' => [
        ...
        'index' => [
            ...
            'installation-processing' => [
                'qubix' => 'Instal·lació de Qubix',
                'qubix-info' => 'Creant les taules de la base de dades, això pot trigar uns moments',
                'title' => 'Instal·lació',
            ],

            'installation-completed' => [
                'admin-panel' => 'Panell d\'administració',
                'qubix-forums' => 'Fòrum de Qubix',
                'customer-panel' => 'Panell de clients',
                'explore-qubix-extensions' => 'Explorar extensions de Qubix',
                'title' => 'Instal·lació completada',
                'title-info' => 'Qubix s\'ha instal·lat correctament al teu sistema.',
            ],

            'ready-for-installation' => [
                'create-database-table' => 'Crear la taula de la base de dades',
                'install' => 'Instal·lació',
                'install-info' => 'Qubix per a la instal·lació',
            ...
            'start' => [
                ...
                'title' => 'La teva instal·lació de Qubix',
                'welcome-title' => 'Benvingut a Qubix',
            ],
            ...
            'back' => 'Enrere',
            'qubix' => 'Qubix',
            'qubix-info' => 'Un projecte comunitari per',
            'qubix-logo' => 'Logotip de Qubix',
            'bengali' => 'Bengalí',
            'catalan' => 'Català',
            'chinese' => 'Xinès',
            'continue' => 'Continuar',
            ...
            'hindi' => 'Hindi',
            'indonesian' => 'Indonesi',
            'installation-description' => "La instal·lació de Qubix generalment implica diversos passos. Aquí tens un esquema general del procés d'instal·lació per a Qubix.",

...
return [
    'seeders' => [
        ...
        'cms' => [
            'pages' => [
                'about-us' => [
                    'content' => 'محتوای این صفحه در حال تکمیل است. لطفاً بزودی دوباره سر بزنید.',
                    'title' => 'درباره ما',
                ],
                ...
                'customer-service' => [
                    'content' => 'اطلاعات خدمات مشتریان ما در حال تکمیل است. در این مدت برای دریافت راهنمایی با ما تماس بگیرید.',
                    'title' => 'خدمات مشتری',
                ],

                'payment-policy' => [
                    'content' => 'سیاست پرداخت ما در حال حاضر در حال تکمیل است. در این مدت برای جزئیات بیشتر با ما تماس بگیرید.',
                    'title' => 'سیاست پرداخت',
                ],

                'privacy-policy' => [
                    'content' => 'سیاست حریم خصوصی ما در حال حاضر در حال تکمیل است. در این مدت برای جزئیات بیشتر با ما تماس بگیرید.',
                    'title' => 'سیاست حفظ حریم خصوصی',
                ],

                'refund-policy' => [
                    'content' => 'سیاست بازپرداخت ما در حال حاضر در حال تکمیل است. در این مدت برای جزئیات بیشتر با ما تماس بگیرید.',
                    'title' => 'سیاست بازپرداخت',
                ],

                'return-policy' => [
                    'content' => 'سیاست بازگشت کالای ما در حال حاضر در حال تکمیل است. در این مدت برای جزئیات بیشتر با ما تماس بگیرید.',
                    'title' => 'سیاست بازگشت',
                ],

                'shipping-policy' => [
                    'content' => 'سیاست ارسال ما در حال حاضر در حال تکمیل است. در این مدت برای جزئیات بیشتر با ما تماس بگیرید.',
                    'title' => 'سیاست حمل و نقل',
                ],

                'terms-conditions' => [
                    'content' => 'قوانین و مقررات ما در حال حاضر در حال تکمیل است. در این مدت برای جزئیات بیشتر با ما تماس بگیرید.',
                    'title' => 'شرایط و مقررات',
                ],

                'terms-of-use' => [
                    'content' => 'شرایط استفاده ما در حال حاضر در حال تکمیل است. در این مدت برای جزئیات بیشتر با ما تماس بگیرید.',
                    'title' => 'شرایط استفاده',
                ],

                'whats-new' => [
                    'content' => 'این بخش با آخرین اخبار در حال به‌روزرسانی است. لطفاً بزودی دوباره سر بزنید.',
                    'title' => 'جدید چیست',
                ],
            ],
        ],
    ...
    'installer' => [
        ...
        'index' => [
            ...
            'installation-processing' => [
                'qubix' => 'نصب Qubix',
                'qubix-info' => 'ایجاد جداول پایگاه داده، این ممکن است چند لحظه طول بکشد',
                'title' => 'نصب',
            ],

            'installation-completed' => [
                'admin-panel' => 'پنل مدیریت',
                'qubix-forums' => 'انجمن Qubix',
                'customer-panel' => 'پنل مشتریان',
                'explore-qubix-extensions' => 'کاوش در افزونه‌های Qubix',
                'title' => 'نصب با موفقیت انجام شد',
                'title-info' => 'Qubix با موفقیت بر روی سیستم شما نصب شده است.',
            ],

            'ready-for-installation' => [
                'create-database-table' => 'ایجاد جدول پایگاه‌داده',
                'install' => 'نصب',
                'install-info' => 'Qubix برای نصب',
            ...
            'start' => [
                ...
                'title' => 'نصب Qubix شما',
                'welcome-title' => 'خوش آمدید به Qubix',
            ],
            ...
            'back' => 'بازگشت',
            'qubix' => 'Qubix',
            'qubix-info' => 'یک پروژه جامعه‌ای توسط',
            'qubix-logo' => 'لوگوی Qubix',
            'bengali' => 'بنگالی',
            'catalan' => 'کاتالان',
            'chinese' => 'چینی',
            'continue' => 'ادامه',
            ...
            'installation-description' => 'نصب Qubix معمولاً شامل چندین مرحله است. در اینجا یک نمای کلی از فرآیند نصب برای Qubix آورده شده است',
            'installation-info' => 'خوشحالیم که شما را اینجا می‌بینیم!',
            'installation-title' => 'به نصب Qubix خوش آمدید',
            'italian' => 'ایتالیایی',
            'japanese' => 'ژاپنی',
            'persian' => 'فارسی',
            'polish' => 'لهستانی',

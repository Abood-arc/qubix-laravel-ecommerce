...
>
    <head>
        ...
        @qubixVite(['src/Resources/assets/css/app.css', 'src/Resources/assets/js/app.js'], 'installer')
        ...
        <link
            type="image/x-icon"
            href="{{ qubix_asset('images/installer/favicon.ico', 'installer') }}"
            rel="shortcut icon"
            sizes="16x16"
        />
        ...
        @pushOnce('scripts')
            ...
            >
                ...
                <div class="flex flex-col justify-center">
                    <div class="m-auto grid h-[100vh] max-w-[362px] items-end">
                        <div class="grid gap-4">
                            <img
                                src="{{ qubix_asset('images/installer/qubix-logo.svg', 'installer') }}"
                                alt="@lang('installer::app.installer.index.qubix-logo')"
                            >
                        ...
                        <p class="mb-6 w-full place-self-end text-left">
                            <a
                                ...
                                href="https://qubix.com/en/"
                            >
                                @lang('installer::app.installer.index.qubix')
                            </a>

                            <span>@lang('installer::app.installer.index.qubix-info')</span>

                            <a
                                class="bg-white text-blue-600 underline"
                                href="https://digitalLabs.com/"
                            >
                                @lang('installer::app.installer.index.digitalLabs')
                            </a>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="flex h-[484px] flex-col justify-center gap-4 overflow-y-auto px-7 py-4">
                        <div class="flex flex-col gap-4">
                            <p class="text-lg font-bold text-gray-800">
                                @lang('installer::app.installer.index.installation-processing.qubix')
                            </p>
                            ...
                            <div class="grid gap-2.5">
                                ...
                                <img
                                    ...
                                    src="{{ qubix_asset('images/installer/spinner.svg', 'installer') }}"
                                    alt="Loading"
                                />

                                <p class="text-sm text-gray-600">
                                    @lang('installer::app.installer.index.installation-processing.qubix-info')
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex h-[484px] flex-col gap-3 overflow-y-auto border-b border-gray-300 px-7 py-4">
                                ...
                                <x-installer::form.control-group class="mb-2.5">
                                    ...
                                    <x-installer::form.control-group.control
                                        type="text"
                                        name="app_name"
                                        ::value="envData.app_name ?? 'Qubix'"
                                        rules="required"
                                        :label="trans('installer::app.installer.index.environment-configuration.application-name')"
                                        :placeholder="trans('installer::app.installer.index.environment-configuration.qubix')"
                                    />
                            ...
                            <div class="flex h-[484px] flex-col gap-3 overflow-y-auto border-b border-gray-300 px-7 py-4">
                                ...
                                <x-installer::form.control-group class="mb-2.5">
                                    ...
                                    <x-installer::form.control-group.control
                                        ...
                                        :placeholder="trans('installer::app.installer.index.create-administrator.qubix')"
                                    />
                ...
                >
                    ...
                    <div class="flex items-center justify-between px-4 py-2.5">
                        <a
                            href="https://forums.qubix.com"
                            class="cursor-pointer text-xs font-semibold text-blue-600"
                        >
                            @lang('installer::app.installer.index.installation-completed.qubix-forums')
                        </a>

                        <a
                            href="https://qubix.com/en/extensions"
                            class="cursor-pointer rounded-md border border-blue-700 bg-white px-3 py-1.5 font-semibold text-blue-600 hover:opacity-90"
                        >
                            @lang('installer::app.installer.index.installation-completed.explore-qubix-extensions')
                        </a>
                    </div>
                </div>
            </script>
                            ...
                            const stepActions = {
                                envDatabase: () => {
                                    if (params.db_connection === 'mysql') {
                                        ...
                                        setErrors({ 'db_connection': ["Qubix currently supports MySQL only."] });
                                    }
                                },

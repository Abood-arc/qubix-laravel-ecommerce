...
use DigitalLabs\Sales\Contracts\Invoice as InvoiceContract;
use DigitalLabs\Sales\Database\Factories\InvoiceFactory;
use DigitalLabs\Sales\Traits\InvoiceReminder;
use DigitalLabs\Sales\Traits\PaymentTerm;

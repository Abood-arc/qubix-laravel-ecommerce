...
namespace DigitalLabs\Sitemap\Jobs;
...
use DigitalLabs\Sitemap\Contracts\Sitemap as SitemapContract;
use DigitalLabs\Sitemap\Models\Category;
use DigitalLabs\Sitemap\Models\Page;
use DigitalLabs\Sitemap\Models\Product;
...
class ProcessSitemap implements ShouldQueue
{
    ...
    protected function generateSitemapIndex(): void
    {
        ...
        foreach ($this->generatedSitemaps as $generatedSitemap) {
            $sitemap->add(url($generatedSitemap));
        }

...
use DigitalLabs\Product\Contracts\ProductCustomizableOptionPrice;
...
class ProductCustomizableOptionPriceRepository extends Repository
{
     ...
     *
     * @param  array  $data
     * @param  \DigitalLabs\Product\Contracts\ProductCustomizableOption  $productCustomizableOption
     * @return void
     */

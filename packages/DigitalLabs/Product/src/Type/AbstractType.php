...
namespace DigitalLabs\Product\Type;
...
use DigitalLabs\Customer\Repositories\CustomerRepository;
use DigitalLabs\Product\DataTypes\CartItemValidationResult;
use DigitalLabs\Product\Exceptions\InsufficientProductInventoryException;
...
use DigitalLabs\Product\Repositories\ProductVideoRepository;
...
abstract class AbstractType
{
     ...
     * Product instance.
     *
     * @var \DigitalLabs\Product\Models\Product
     */
    protected $product;
     ...
     * Create product.
     *
     * @return \DigitalLabs\Product\Contracts\Product
     */
    ...
    /**
     * @param  string  $code
     * @return \DigitalLabs\Attribute\Contracts\Attribute
     */
     ...
     *
     * @param  \DigitalLabs\Product\Models\Product  $product
     */
     ...
     * @return \DigitalLabs\Product\Type\AbstractType
     */
     ...
     *
     * @param  \DigitalLabs\Checkout\Contracts\CartItem  $cartItem
     * @return bool
     */
     ...
     *
     * @param  \DigitalLabs\Checkout\Contracts\CartItem  $item
     * @return bool
     */
     ...
     *
     * @param  \DigitalLabs\Attribute\Contracts\Group  $group
     ...
     * Get tax category.
     *
     * @return \DigitalLabs\Tax\Models\TaxCategory
     */
     ...
     *
     * @param  \DigitalLabs\Checkout\Contracts\CartItem  $item
     * @return \DigitalLabs\Checkout\Contracts\CartItem|\DigitalLabs\Sales\Contracts\OrderItem|\DigitalLabs\Sales\Contracts\InvoiceItem|\DigitalLabs\Sales\Contracts\ShipmentItem|\DigitalLabs\Customer\Contracts\Wishlist
     */
     ...
     *
     * @param  \DigitalLabs\Customer\Contracts\CartItem|\DigitalLabs\Checkout\Contracts\CartItem  $item
     * @return array
     */
     ...
     */
    public function isCartItemInactive(\DigitalLabs\Checkout\Contracts\CartItem $item): bool
    {

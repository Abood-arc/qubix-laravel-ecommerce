...
use DigitalLabs\Admin\Validations\ConfigurableUniqueSku;
use DigitalLabs\Checkout\Models\CartItem as CartItemModel;
...
use DigitalLabs\Product\Helpers\Indexers\Price\Configurable as ConfigurableIndexer;
use DigitalLabs\Tax\Facades\Tax;
...
class Configurable extends AbstractType
{
     ...
     *
     * @param  \DigitalLabs\Customer\Contracts\Wishlist  $item
     * @return bool
     */
    ...
    {
        $childProduct = app('DigitalLabs\Product\Repositories\ProductRepository')->find($data['selected_configurable_option']);
     ...
     *
     * @param  \DigitalLabs\Customer\Contracts\Wishlist|\DigitalLabs\Checkout\Contracts\CartItem  $item
     * @return array
     */
    public function getBaseImage($item)
    {
        ...
        if ($item instanceof \DigitalLabs\Customer\Contracts\Wishlist) {
     ...
     *
     * @param  \DigitalLabs\Product\Type\CartItem  $item
     */

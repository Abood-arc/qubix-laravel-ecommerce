...
namespace DigitalLabs\Theme\Models;

use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use DigitalLabs\Admin\Database\Factories\ThemeFactory;
use DigitalLabs\Core\Eloquent\TranslatableModel;
use DigitalLabs\Theme\Contracts\ThemeCustomization as ThemeCustomizationContract;

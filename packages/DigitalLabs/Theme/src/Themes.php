...
namespace DigitalLabs\Theme;

use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Vite;
use Illuminate\Support\Str;
use DigitalLabs\Theme\Exceptions\ViterNotFound;
...
class Themes
{
     ...
     * Enable theme.
     *
     * @return \DigitalLabs\Theme\Theme
     */
    ...
    public function url(string $filename, ?string $namespace = null)
    {
         ...
         */
        $viters = config('qubix-vite.viters');
    ...
    /**
     * Set qubix vite in current theme.
     *
     * @param  mixed  $entryPoints
     * @return mixed
     */
    public function setQubixVite($entryPoints, ?string $namespace = null)
    {
        /**
         * If the namespace is null, it means the theming system is activated. We use the request URI to
         * detect the theme and provide Vite assets based on the current theme.
        ...
        if (empty($namespace)) {
            ...
            return $currentTheme->setQubixVite($entryPoints);
        }
